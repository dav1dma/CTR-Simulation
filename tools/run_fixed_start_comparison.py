...
R=Path('results/fixed_start_comparison_20260909');P=Path('output/fixed_start_comparison')
DESIGNS=[BASE,np.array([28.68,21.06,47.,27.5])]
...
def run():
 ...
 summaries=[]
 for name,d in zip(['Original','B1'],DESIGNS):
