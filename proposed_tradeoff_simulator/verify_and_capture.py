...
def main():
    out=Path(__file__).resolve().parents[1]/'output/task_prioritised_tradeoff_20260914/workspace_viewer'
    ...
    v.last_action='Proposed trade-off | original controller | ideal model';v.update_status();app.process_events()
