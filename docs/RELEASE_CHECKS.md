...
- Recomputing occupied-cell volume and volume-weighted fixed-start success from the downloaded dense archive reproduced **2396.25 / 2582.78 cm³** and **62.280 / 66.993%**, respectively, with 262,144 states per design and 59,341 common targets.
